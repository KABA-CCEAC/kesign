...
!(function () {
  ...
  var touchend = function (e) {
    ...
    PUSH({
      ...
      transition : target.getAttribute('data-transition') || 'fade'
    });
  };
  ...
  var swapContent = function (swap, container, transition, complete) {
    ...
    if (/slide/.test(transition)) {
      ...
      container.parentNode.classList.add('push-transition');
      ...
      function slideEnd() {
        ...
        swap.classList.remove(swapDirection);
        container.parentNode.classList.remove('push-transition');
        container.parentNode.removeChild(container);
        complete && complete();
      }
    }
  ...
  window.addEventListener('click', touchend);//function (e) { if (getTarget(e)) e.preventDefault(); });
